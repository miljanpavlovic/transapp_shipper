 ...
 */
public class SpanFixedTextView extends TextView {
    ...
    public SpanFixedTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SpanFixedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SpanFixedTextView(Context context) {
        super(context);
    }
